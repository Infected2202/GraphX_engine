...
from .rotor import (
    desync_pair_month,
    flip_ab_on_next_token,
    phase_shift_minus_one_skip,
    phase_shift_plus_one_insert_off,
)
...
def apply_pair_breaking(
    ...
    for emp_a, emp_b, _, _ in target_pairs:
        ...
        if (pred_hours_cum + dHpred1) < -hours_budget:
            ...
            test_sched, dh1, ok1, note1 = phase_shift_minus_one_skip(
                cur_sched,
                code_of,
                minus_emp,
                window,
        ...
        if (pred_hours_cum + dHpred2) < -hours_budget:
            ...
            test_sched2, dh2, ok2, note2 = phase_shift_plus_one_insert_off(
                cur_sched,
                code_of,
                plus_emp,
                window,
        ...
        flip_sched_d, _, ok_flip_d, note_flip_d = flip_ab_on_next_token(
            cur_sched,
            code_of,
            minus_emp,
            window,
        ...
        flip_sched_n, _, ok_flip_n, note_flip_n = flip_ab_on_next_token(
            cur_sched,
            code_of,
            plus_emp,
            window,
    ...
    for a, b, _, _ in target_pairs:
        ...
        fixed_sched, flips, notes = desync_pair_month(cur_sched, code_of, a, b)
